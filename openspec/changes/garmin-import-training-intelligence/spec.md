# Garmin Import + Training Intelligence — Specification

## Purpose

Defines requirements and acceptance scenarios for `.fit` file import, parsed metrics display, AI-powered training evaluation, and adaptation warnings. This is a new feature domain with no prior specs.
