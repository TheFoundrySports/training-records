...
import { OUTCOME_ICON, OUTCOME_LABEL, OUTCOME_VAR } from './OutcomesWidget.constants'
...
function OutcomeTileLink({ tile }: { tile: OutcomesTile }) {
  const Icon = OUTCOME_ICON[tile.outcome]
  ...
  return (
    ...
    >
      ...
      <div className="value">{tile.count}</div>
