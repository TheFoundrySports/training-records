...
describe('useUpdateBJJWorkout', () => {
  ...
  it('calls bjj_update_workout RPC with correct payload', async () => {
    ...
    mockRpc.mockResolvedValueOnce({ data: null, error: null, count: null, status: 200, statusText: 'OK', success: true })
  ...
  it('surfaces error on RPC failure', async () => {
    ...
    const rpcError = { message: 'Unauthorized', code: 'UNAUTHORIZED', details: '', hint: '', name: 'PostgrestError', toJSON() { return this } }
    mockRpc.mockResolvedValueOnce({ data: null, error: rpcError, count: null, status: 401, statusText: 'Unauthorized', success: false })
