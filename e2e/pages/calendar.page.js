...
class CalendarPage {
    ...
    async goto() {
        ...
        await (0, test_1.expect)(this.monthTitle).toBeVisible();
    }
     ...
     */
    async clickEmptyDayByLabel(date) {
