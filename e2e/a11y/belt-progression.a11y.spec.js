 ...
 */
(0, pages_fixture_1.test)('a11y - no critical violations at /bjj/blue-belt-progression', async ({ page }) => {
    await page.goto('/bjj/blue-belt-progression');
    await (0, pages_fixture_1.expect)(page).toHaveURL(/bjj\/blue-belt-progression/);
